...
using ADCCure.TaskScheduler;

namespace ADCCure.Configurator.DAL
{
    [XmlRoot("installable", Namespace = "http://adccure.nl/installables")]
    public sealed class Installables
    {
        ...
        {
            var ser = new XmlSerializer(typeof(Installables));
        ...
        private ServiceAccount _mServiceAccount;
        ...
        {
            get { return _mServiceAccount ?? (_mServiceAccount = new ServiceAccount()); }
            set
            {
                _mServiceAccount = value;
            }
        }
    ...
    public sealed class FindReplaceVar
    {
        ...
        public int ToOrdinal
        {
            get
            {
                int bl = Replace.IndexOf("{ASK_VARIABLE", StringComparison.Ordinal);
            ...
            get
            {
                switch (AppName)
                {
                    ...
                    case EnumDependencies.x64:
                        return util.IsWindowsX64Process;
                    default:
                        return false;
                }
            }
    ...
    public sealed class DbInstallType
    {
        ...
        /// </summary>
        [XmlAttribute("includeProviderPrefix"), DefaultValue(false)]
        public bool IncludeProviderPrefix { get; set; }
    ...
    public sealed class Database
    {
        ...
        public IList<FindReplaceVar> ReplaceVariables { get; set; }

        private bool? _mCanConnect;
        /// <summary>
        /// one DB can have several 'types' eg.. Oracle, SQL Server, Informix
        /// </summary>
        private readonly List<DbInstallType> m_DbTypes;
        public Database()
        {
            ...
            switch (ActionType)
            {
                case ActionType.StartupTask:
                    if (ServiceAccount != null)
                    {
                        ...
                        Task tsk = st.GetTaskNames().Exists(t => t.StartsWith(this.Name, StringComparison.InvariantCultureIgnoreCase)) ? 
                            st.OpenTask(this.Name) : st.CreateTask(this.Name);
    ...
    public sealed class Service
    {
        ...
        /// <summary>
        /// the windows service controller name
        /// </summary>
    ...
    public sealed class Webservice
    {
        ...
        private static IList<Site> _sites;
        [XmlArray("appDependencies")]
        public List<AppDependencies> AppDependency { get; set; }
        public Webservice()
        {
        ...
        private IList<FindReplaceVar> _findReplaceVars;
        [XmlAttribute("name")]
        public string Name { get; set; }
        [XmlElement("application")]
        public IList<Application> Application;
        /// <summary>
        /// basepath and all subpaths will be considered part of the service
            ...
            get
            {
                ...
                if (string.IsNullOrEmpty(m_ProductLocation))
                {
                    if (UpgradeCode == Guid.Empty)
                    {
                        // not from an MSI
                        int instance;
                        if (IIS.VDirExists(_sites, VirtualDir, out instance))
                        {
        ...
        /// </summary>
        [XmlArray("findReplaceVars")]
        public IList<FindReplaceVar> ReplaceVariables
        {
            get { return _findReplaceVars; }
            set { _findReplaceVars = value; }
