...
namespace ADCCure.TaskScheduler
{
    ...
    /// </remarks>
    public sealed class ScheduledTasks : IDisposable
    {
        /// <summary>
        ...
        {
            Type typ = Type.GetTypeFromCLSID(new Guid("148BD52A-A2AB-11CE-B11F-00AA00530503"));
            
            its = (ITaskScheduler)Activator.CreateInstance(typ);
        }
        ...
        static ScheduledTasks()
        {
            ...
            CTaskGuid = new Guid("148BD520-A2AB-11CE-B11F-00AA00530503"); 
        }
    }
}