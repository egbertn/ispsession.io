...
namespace ADCCure.TaskScheduler
{
    ...
    public sealed class Task : IDisposable
    {
        ...
        internal Task(ITask iTask, string taskName)
        {
            ...
            name = taskName.EndsWith(".job") ? taskName.Substring(0, taskName.Length - 4)
                :
                taskName;
            triggers = null;
        ...
        public DateTime NextRunTimeAfter(DateTime after)
        {
            ...
            SystemTime stAfter = new SystemTime(after);
            ...
            stLimit = stAfter;
            stLimit.Year = (short)DateTime.MaxValue.Year;
