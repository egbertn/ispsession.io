...
namespace ADCCure.TaskScheduler
{
    ...
    public class TriggerList : IList<Trigger>, IDisposable
    {
        ...
        internal TriggerList(ITask iTask)
        {
            ...
            oTriggers = new List<Trigger>(cnt + 5); //Allow for five additional entries without growing base array
            for (int i = 0; i < cnt; i++)
            {
        ...
        /// </summary>
        private sealed class Enumerator : IEnumerator<Trigger>
        {
        ...
        void IList<Trigger>.Insert(int index, Trigger value)
        {
        ...
        ///// </summary>
        //void IList<Trigger>.Remove(Trigger value) {
        //    Remove(value );
        //}
        ...
        ///// </summary>
        //bool IList<Trigger>.Contains(Trigger value) {
        ...
        /// </summary>
        int IList<Trigger>.IndexOf(Trigger value)
        {
        ...
        ///// </summary>
        //int IList<Trigger>.Add(Trigger value) {
        ...
        public System.Collections.Generic.IEnumerator<TaskScheduler.Trigger> GetEnumerator()
        {
        ...
        public void Dispose()
        {
            foreach (Trigger o in oTriggers)
            {
                o.Unbind();
            }
            oTriggers = null;
